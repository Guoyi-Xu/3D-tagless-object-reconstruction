...
% Load the data.
load('data_wo_Pragya_standing_x6y6_v1_to_v2_rm0.mat');
data_wo = [chindexlist, tagindexlist, antennalist, rssiimpinjlist, rssiimpinjlist_d, phasedeglist];
load('data_w_Pragya_standing_x6y6_v1-2_rm0.mat');
...
save_name = 'image_3D_me_standing_x6y6.mat';
